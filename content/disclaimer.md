...
Any investment decisions you make are solely your responsibility. Before making any investment decisions, you should:
...
Past performance does not guarantee future results. Historical data presented on this website, including average returns after stocks touch their 200-week moving average, is provided for informational purposes only and should not be used to predict future performance.

## Data Accuracy

While we strive to provide accurate data, we make no guarantees about the accuracy, completeness, or timeliness of the information on this website. Stock prices and calculated metrics are updated weekly and may not reflect real-time market conditions.

## Risk of Loss

Trading and investing in securities involves substantial risk of loss. You should be aware that you could lose some or all of your investment. Only invest money that you can afford to lose.
