...
newly_below:
  ...
  - symbol: "CLBT"
    ...
    rsi_14: 42.1
    rvol_14: 4.5
    accumulation_ratio: 0.51
    volume_signal: "capitulation"
    touch_count: 6
    avg_return_after_touch: 79.9
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "growing"
    fcf_yield: 4.0
    has_conviction_buy: false
    sector: "Technology - Digital Intelligence"
    market_cap_display: "$2.8B"
  - symbol: "JD"
    name: "JD.com Inc."
    close: 29.06
    pct_below: 8.9
    ...
    rsi_14: 47.3
    rvol_14: 2.0
    accumulation_ratio: 1.00
    volume_signal: "capitulation"
    touch_count: 12
    avg_return_after_touch: -19.5
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "volatile"
  ...
  - symbol: "IHRT"
    ...
    rsi_14: 23.5
    rvol_14: 0.9
    accumulation_ratio: 0.78
    volume_signal: "neutral"
    touch_count: 3
    avg_return_after_touch: 43.2
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "declining"
  ...
  - symbol: "NATR"
    ...
    rsi_14: 15.6
    rvol_14: 2.3
    accumulation_ratio: 0.89
    volume_signal: "capitulation"
    touch_count: 13
    avg_return_after_touch: 0.6
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: true
    fcf_trend: "volatile"
    fcf_yield: 6.2
    has_conviction_buy: true
    sector: "Consumer Defensive - Packaged Foods"
    market_cap_display: "$266M"
  - symbol: "EDU"
    ...
    rsi_14: 49.3
    rvol_14: 1.0
    accumulation_ratio: 1.07
    volume_signal: "neutral"
    touch_count: 19
    avg_return_after_touch: 27.5
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "volatile"
    fcf_yield: 10.9
    has_conviction_buy: false
    sector: "Consumer Discretionary - Education"
    market_cap_display: "$8.8B"
  - symbol: "PVH"
    name: "PVH Corp."
    close: 82.47
    pct_below: 5.1
    ...
    rsi_14: 45.1
    rvol_14: 0.9
    accumulation_ratio: 0.69
    volume_signal: "distribution"
    touch_count: 38
    avg_return_after_touch: 16.7
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "insufficient_data"
  ...
  - symbol: "PGNY"
    ...
    rsi_14: 58.1
    rvol_14: 0.8
    accumulation_ratio: 1.04
    volume_signal: "neutral"
    touch_count: 10
    avg_return_after_touch: -1.7
    buffett_quality: true
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "growing"
    fcf_yield: 10.0
    has_conviction_buy: true
    sector: "Healthcare - Fertility Benefits"
    market_cap_display: "$2.0B"
  - symbol: "LPX"
    ...
    rsi_14: 49.4
    rvol_14: 1.1
    accumulation_ratio: 1.01
    volume_signal: "neutral"
    touch_count: 29
    avg_return_after_touch: 27.8
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "insufficient_data"
  ...
  - symbol: "JBLU"
    ...
    rsi_14: 55.2
    rvol_14: 0.8
    accumulation_ratio: 1.11
    volume_signal: "neutral"
    touch_count: 19
    avg_return_after_touch: -8.5
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "declining"
  ...
  - symbol: "MATV"
    ...
    rsi_14: 63.2
    rvol_14: 1.7
    accumulation_ratio: 1.06
    volume_signal: "neutral"
    touch_count: 19
    avg_return_after_touch: -5.2
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "insufficient_data"
  ...
  - symbol: "ZUMZ"
    ...
    rsi_14: 32.5
    rvol_14: 1.1
    accumulation_ratio: 0.88
    volume_signal: "neutral"
    touch_count: 18
    avg_return_after_touch: 32.4
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: true
    fcf_trend: "volatile"
  ...
  - symbol: "AZO"
    ...
    rsi_14: 34.6
    rvol_14: 0.7
    accumulation_ratio: 1.33
    volume_signal: "neutral"
    touch_count: 17
    avg_return_after_touch: 30.5
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "declining"
    fcf_yield: 1.8
    has_conviction_buy: false
    sector: "Consumer Discretionary - Auto Parts Retail"
    market_cap_display: "$49.4B"
  - symbol: "POWI"
  ...
  - symbol: "LOPE"
    ...
    rsi_14: 35.3
    rvol_14: 0.8
    accumulation_ratio: 1.09
    volume_signal: "neutral"
    touch_count: 16
    avg_return_after_touch: 15.4
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "insufficient_data"
  ...
  - symbol: "EVCM"
    ...
    rsi_14: 43.2
    rvol_14: 1.1
    accumulation_ratio: 1.08
    volume_signal: "neutral"
    touch_count: 10
    avg_return_after_touch: 12.8
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "growing"
    fcf_yield: 5.7
    has_conviction_buy: false
    sector: "Technology - Service Commerce Software"
    market_cap_display: "$1.8B"
  - symbol: "LOW"
    ...
    rsi_14: 43.7
    rvol_14: 0.8
    accumulation_ratio: 0.99
    volume_signal: "neutral"
    touch_count: 24
    avg_return_after_touch: 22.6
    buffett_quality: false
    dividend_aristocrat: true
    yartseva_candidate: false
    fcf_trend: "insufficient_data"
  ...
  - symbol: "SFM"
    ...
    rsi_14: 49.7
    rvol_14: 0.6
    accumulation_ratio: 1.31
    volume_signal: "neutral"
    touch_count: 13
    avg_return_after_touch: -2.9
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "insufficient_data"
  ...
  - symbol: "ALK"
    ...
    rsi_14: 55.8
    rvol_14: 0.8
    accumulation_ratio: 1.14
    volume_signal: "neutral"
    touch_count: 34
    avg_return_after_touch: 16.1
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "declining"
  ...
  - symbol: "NCLH"
    ...
    rsi_14: 58.8
    rvol_14: 0.8
    accumulation_ratio: 1.24
    volume_signal: "neutral"
    touch_count: 21
    avg_return_after_touch: 21.0
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "insufficient_data"
  ...
  - symbol: "STRA"
    ...
    fcf_yield: 0.0
    has_conviction_buy: false
    sector: "Consumer Discretionary - Education Services"
    market_cap_display: "N/A"
  - symbol: "ALRM"
    ...
    rsi_14: 63.5
    rvol_14: 0.8
    accumulation_ratio: 0.98
    volume_signal: "neutral"
    touch_count: 7
    avg_return_after_touch: 31.3
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "growing"
  ...
  - symbol: "AEO"
    ...
    rsi_14: 48.4
    rvol_14: 1.2
    accumulation_ratio: 0.94
    volume_signal: "neutral"
    touch_count: 32
    avg_return_after_touch: 12.9
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "volatile"
  ...
  - symbol: "CXT"
    ...
    rsi_14: 58.4
    rvol_14: 0.7
    accumulation_ratio: 1.27
    volume_signal: "neutral"
    touch_count: 25
    avg_return_after_touch: 12.5
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "declining"
    fcf_yield: 8.1
    has_conviction_buy: true
    sector: "Industrials - Security & Detection"
    market_cap_display: "$3.0B"
  - symbol: "GBTC"
    ...
    rsi_14: 26.3
    rvol_14: 0.8
    accumulation_ratio: 0.87
    volume_signal: "neutral"
    touch_count: 6
    avg_return_after_touch: 251.2
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "insufficient_data"
  ...
  - symbol: "UHS"
    ...
    rsi_14: 50.2
    rvol_14: 0.7
    accumulation_ratio: 0.96
    volume_signal: "neutral"
    touch_count: 39
    avg_return_after_touch: 28.4
    buffett_quality: false
    dividend_aristocrat: false
    yartseva_candidate: false
    fcf_trend: "growing"
