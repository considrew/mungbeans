---
title: "StealthGas (GASS): Deep Value or Value Trap?"
date: 2026-02-22
draft: false
tags: ["deep-dive", "value-trap-analysis", "shipping", "LPG", "GASS"]
description: "A forensic value analysis of StealthGas, the world's largest owner of small pressurized LPG carriers, trading at 44% of book value with zero debt. We apply our five-layer screening framework to a shipping company that looks almost too cheap to be real."
ticker: "GASS"
verdict: "deep-value"
verdict_label: "Deep Value (w/ Governance Discount)"
pct_below_200wma: "0"
performance_since: "+22.2%"
performance_price_at_publish: "$8.24"
performance_price_current: "$10.07"
...
This is the easiest layer StealthGas has ever had to pass. The Altman Z-Score is 9.87 — not just above the 3.0 "safe" threshold, but among the highest Z-Scores we've ever calculated in this series. For reference, [PayPal](/deep-dives/paypal-deep-value-or-value-trap/) scored 4.78 and [The Trade Desk](/deep-dives/trade-desk-deep-value-or-value-trap/) scored 4.31.
...
| Scenario | Basis | Implied Price | From Current |
|----------|-------|---------------|-------------|
...
| Scenario | Basis | Implied Price | From Current |
|----------|-------|---------------|-------------|
| Peer multiple convergence | 10x earnings ($1.65 EPS) | $16.50 | +98% |
