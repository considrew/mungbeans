---
title: "Fidelity National Information Services (FIS): Deep Value or Value Trap?"
date: 2026-04-18
draft: false
tags: ["deep-dive", "value-trap-analysis", "fintech", "FIS"]
description: "FIS is 26% below its 200-week moving average and trading at 7x forward earnings — the cheapest it's been since the Worldpay meltdown. But this is a different company than it was in 2022."
ticker: "FIS"
verdict: "deep-value"
...
performance_price_current: "$43.49"
...
| Company | Forward PE | Revenue Growth | FCF Yield | Signal |
|---|---|---|---|---|
| FIS | 7.3x | 30%* | 7.2% | Deep discount |
| [Fiserv (FI)](/stocks/fi/) | ~18x | ~8% | ~4% | Premium priced |
| Jack Henry (JKHY) | ~28x | ~7% | ~3% | Significant premium |
| [Global Payments (GPN)](/stocks/gpn/) | 4.2x | ~5% | 9.2% | Also cheap |
| [PayPal (PYPL)](/stocks/pypl/) | 7.8x | ~5% | 7.7% | Comparable |
...
| Metric | Current | Context | Signal |
|---|---|---|---|
| Trailing P/E | 69.1x | Distorted by write-downs | Ignore |
| Forward P/E | 7.3x | vs. peer avg ~18x | Extreme discount |
| FCF Yield (TTM) | 7.2% | On GAAP FCF of $1.9B | Attractive |
| EV/Revenue | ~2.4x | vs. Fiserv ~6x | Significant discount |
| Dividend Yield | 3.3% | Covered by FCF | Stable |
| Buyback Yield | 6.3% | Aggressive repurchase | Shareholder-friendly |
| Debt/Equity | 91% | Post-acquisition elevated | Monitor |
...
| Scenario | Assumed EPS/FCF | Multiple | Implied Price | From Current |
|----------|----------------|----------|---------------|-------------|
| Bear case (integration stumbles, growth stalls) | $5.50 adj EPS | 8x | $44 | -11% |
| Stress case (recession + integration failure) | $4.50 adj EPS | 6x | $27 | -46% |
| Base case (execution on plan) | $6.25 adj EPS | 12x | $75 | +51% |
| Bull case (re-rating toward Fiserv) | $6.25 adj EPS | 16x | $100 | +101% |
| FCF-based (2028 $3B FCF at 12x) | $3B FCF | 12x | $67* | +35% |
...
*[View FIS on the mungbeans.io screener →](/stocks/fis/)*
