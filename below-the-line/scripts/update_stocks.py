...
from dislocation_scores import (
    compute_stock_dislocation,
    apply_cross_sectional_dislocation,
)
...
STOCK_UNIVERSE = [
    'A', 'AA', 'AAL', 'AAOI', 'AAON', 'AAP', 'AAPL', 'ABBV', 'ABCB', 'ABEV',
    'ABG', 'ABM', 'ABNB', 'ABR', 'ABT', 'ACAD', 'ACB', 'ACCO', 'ACGL', 'ACHR',
    'ACIW', 'ACLS', 'ACLX', 'ACM', 'ACMR', 'ACN', 'ACVA', 'ADBE', 'ADC', 'ADEA',
    'ADI', 'ADM', 'ADMA', 'ADNT', 'ADP', 'ADPT', 'ADSK', 'ADTN', 'ADUS', 'AEE',
    'AEIS', 'AEM', 'AEO', 'AEP', 'AES', 'AFG', 'AFL', 'AFRM', 'AG', 'AGCO',
    'AGNC', 'AGO', 'AHCO', 'AI', 'AIG', 'AIN', 'AIT', 'AIV', 'AIZ', 'AJG',
    'AKAM', 'AKR', 'ALB', 'ALEC', 'ALGM', 'ALGN', 'ALGT', 'ALHC', 'ALIT', 'ALK',
    'ALKS', 'ALKT', 'ALL', 'ALLE', 'ALLO', 'ALLY', 'ALNY', 'ALRM', 'ALRS', 'AM',
    'AMAT', 'AMBA', 'AMC', 'AMCR', 'AMD', 'AME', 'AMG', 'AMGN', 'AMKR', 'AMP',
    'AMPH', 'AMPL', 'AMPX', 'AMR', 'AMRC', 'AMRX', 'AMT', 'AMWD', 'AMZN', 'ANAB',
    'ANDE', 'ANET', 'ANF', 'ANGI', 'ANIK', 'ANIP', 'AON', 'AORT', 'AOS', 'AOSL',
    'APA', 'APAM', 'APD', 'APEI', 'APG', 'APH', 'APLD', 'APLE', 'APLS', 'APO',
    'APOG', 'APP', 'APPF', 'APPN', 'APPS', 'APTV', 'AQN', 'AR', 'ARAY', 'ARCB',
    'ARCC', 'ARCT', 'ARDX', 'ARE', 'ARES', 'ARGX', 'ARHS', 'ARIS', 'ARKO', 'ARLP',
    'ARM', 'AROC', 'AROW', 'ARQT', 'ARR', 'ARRY', 'ARTNA', 'ARVN', 'ARW', 'ASAN',
    'ASB', 'ASC', 'ASGN', 'ASIX', 'ASLE', 'ASML', 'ASPI', 'ASPN', 'ASTE', 'ASTS',
    'ATEC', 'ATEN', 'ATHM', 'ATI', 'ATKR', 'ATNI', 'ATO', 'ATRA', 'ATRC', 'ATRO',
    'AUB', 'AUR', 'AVA', 'AVAH', 'AVAV', 'AVB', 'AVGO', 'AVNS', 'AVNT', 'AVNW',
    'AVO', 'AVPT', 'AVTR', 'AVY', 'AWI', 'AWK', 'AWR', 'AX', 'AXGN', 'AXON',
    'AXP', 'AXS', 'AXSM', 'AXTA', 'AXTI', 'AYI', 'AZN', 'AZO', 'AZTA', 'AZZ',
    'B', 'BA', 'BABA', 'BAC', 'BALL', 'BALY', 'BAM', 'BANC', 'BANF', 'BANR',
    'BARK', 'BAX', 'BB', 'BBAI', 'BBW', 'BBY', 'BC', 'BCC', 'BCE', 'BCML',
    'BCO', 'BCPC', 'BCRX', 'BCSF', 'BDC', 'BDX', 'BE', 'BEAM', 'BEN', 'BEP',
    'BF-B', 'BFAM', 'BG', 'BGC', 'BGS', 'BHB', 'BHE', 'BHF', 'BHP', 'BHVN',
    'BIDU', 'BIIB', 'BILI', 'BILL', 'BIO', 'BIRK', 'BJ', 'BJRI', 'BKD', 'BKE',
    'BKH', 'BKNG', 'BKR', 'BKSY', 'BKU', 'BL', 'BLBD', 'BLCO', 'BLD', 'BLDR',
    'BLFS', 'BLK', 'BLKB', 'BLMN', 'BLNK', 'BMBL', 'BMI', 'BMRC', 'BMRN', 'BMY',
    'BN', 'BNL', 'BNS', 'BNTX', 'BNY', 'BOH', 'BOKF', 'BOOM', 'BOOT', 'BOX',
    'BP', 'BPOP', 'BR', 'BRBR', 'BRC', 'BRCC', 'BRK-B', 'BRKR', 'BRO', 'BROS',
    'BRSP', 'BRX', 'BRZE', 'BSBR', 'BSM', 'BSRR', 'BSX', 'BTAI', 'BTBT', 'BTDR',
    'BTG', 'BTI', 'BTU', 'BUD', 'BURL', 'BUSE', 'BV', 'BWA', 'BWFG', 'BWXT',
    'BX', 'BXC', 'BXMT', 'BXP', 'BXSL', 'BY', 'BYD', 'BYND', 'C', 'CAC',
    'CACC', 'CACI', 'CAG', 'CAH', 'CAKE', 'CAL', 'CALM', 'CALX', 'CAMP', 'CAMT',
    'CAR', 'CARG', 'CARR', 'CASS', 'CASY', 'CAT', 'CATC', 'CATO', 'CATY', 'CAVA',
    'CB', 'CBAN', 'CBFV', 'CBL', 'CBNK', 'CBOE', 'CBRE', 'CBRL', 'CBT', 'CBU',
    'CBZ', 'CC', 'CCBG', 'CCI', 'CCJ', 'CCL', 'CCNE', 'CCOI', 'CCS', 'CCSI',
    'CDE', 'CDNA', 'CDNS', 'CDP', 'CDRE', 'CDW', 'CDXS', 'CE', 'CECO', 'CEG',
    'CELH', 'CENT', 'CENTA', 'CENX', 'CERS', 'CERT', 'CEVA', 'CF', 'CFFI', 'CFG',
    'CFR', 'CG', 'CGC', 'CGNX', 'CHCT', 'CHD', 'CHDN', 'CHE', 'CHEF', 'CHGG',
    'CHH', 'CHPT', 'CHRD', 'CHRS', 'CHRW', 'CHTR', 'CHWY', 'CI', 'CIEN', 'CIFR',
    'CIGI', 'CIM', 'CINF', 'CIVB', 'CL', 'CLB', 'CLBK', 'CLBT', 'CLDT', 'CLF',
    'CLFD', 'CLH', 'CLNE', 'CLOV', 'CLPR', 'CLSK', 'CLVT', 'CLW', 'CLX', 'CMC',
    'CMCO', 'CMCSA', 'CME', 'CMG', 'CMI', 'CMPR', 'CMRE', 'CMS', 'CMT', 'CNA',
    'CNC', 'CNDT', 'CNI', 'CNK', 'CNMD', 'CNNE', 'CNO', 'CNOB', 'CNP', 'CNTY',
    'CNX', 'CNXC', 'COF', 'COGT', 'COHR', 'COHU', 'COIN', 'COKE', 'COLD', 'COLL',
    'COLM', 'COMP', 'COO', 'COP', 'COR', 'CORT', 'CORZ', 'COST', 'COTY', 'COUR',
    'CP', 'CPAY', 'CPB', 'CPK', 'CPNG', 'CPRI', 'CPRT', 'CPRX', 'CPT', 'CQP',
    'CR', 'CRBG', 'CRC', 'CRCL', 'CRGY', 'CRH', 'CRI', 'CRK', 'CRL', 'CRM',
    'CRMD', 'CRMT', 'CRNX', 'CRON', 'CROX', 'CRS', 'CRSP', 'CRSR', 'CRTO', 'CRUS',
    'CRVL', 'CRWD', 'CSCO', 'CSGP', 'CSGS', 'CSIQ', 'CSTL', 'CSTM', 'CSV', 'CSWC',
    'CSX', 'CTAS', 'CTO', 'CTRA', 'CTSH', 'CTVA', 'CUBI', 'CUK', 'CURLF', 'CUZ',
    'CVBF', 'CVCO', 'CVGI', 'CVGW', 'CVLG', 'CVLT', 'CVNA', 'CVS', 'CVX', 'CW',
    'CWAN', 'CWEN', 'CWH', 'CWST', 'CXM', 'CXT', 'CXW', 'CYH', 'CYRX', 'CYTK',
    'CZR', 'D', 'DAC', 'DAKT', 'DAL', 'DAN', 'DAR', 'DASH', 'DAWN', 'DBD',
    'DBI', 'DBX', 'DCBO', 'DCGO', 'DCI', 'DD', 'DDD', 'DDOG', 'DDS', 'DE',
    'DEA', 'DECK', 'DEI', 'DELL', 'DEO', 'DFIN', 'DG', 'DGII', 'DGX', 'DHC',
    'DHI', 'DHR', 'DHT', 'DIN', 'DINO', 'DIOD', 'DIS', 'DJT', 'DKNG', 'DKS',
    'DLB', 'DLHC', 'DLO', 'DLR', 'DLTR', 'DLX', 'DMLP', 'DNA', 'DNLI', 'DNN',
    'DNOW', 'DNUT', 'DOC', 'DOCN', 'DOCS', 'DOCU', 'DOMO', 'DORM', 'DOV', 'DOW',
    'DOX', 'DPZ', 'DQ', 'DRH', 'DRI', 'DRVN', 'DSGX', 'DSX', 'DT', 'DTE',
    'DTM', 'DUK', 'DUOL', 'DV', 'DVA', 'DVN', 'DX', 'DXC', 'DXCM', 'DY',
    'EA', 'EAT', 'EBAY', 'EBC', 'ECL', 'ECPG', 'ECVT', 'ED', 'EDIT', 'EDU',
    'EE', 'EEFT', 'EFSC', 'EFX', 'EG', 'EGBN', 'EGO', 'EGP', 'EHC', 'EIX',
    'EL', 'ELF', 'ELME', 'ELS', 'ELV', 'EMBC', 'EME', 'EMN', 'EMR', 'ENB',
    'ENOV', 'ENPH', 'ENS', 'ENSG', 'ENTA', 'ENTG', 'ENVA', 'ENVX', 'EOG', 'EPAC',
    'EPAM', 'EPC', 'EPD', 'EPM', 'EPRT', 'EQBK', 'EQH', 'EQIX', 'EQNR', 'EQR',
    'EQT', 'ERIE', 'ERII', 'ERJ', 'ES', 'ESCA', 'ESE', 'ESEA', 'ESI', 'ESNT',
    'ESPR', 'ESRT', 'ESS', 'ESTA', 'ESTC', 'ET', 'ETD', 'ETHE', 'ETN', 'ETR',
    'ETSY', 'EU', 'EVC', 'EVCM', 'EVER', 'EVGO', 'EVH', 'EVLV', 'EVR', 'EVRG',
    'EVTC', 'EW', 'EWBC', 'EXC', 'EXE', 'EXEL', 'EXLS', 'EXP', 'EXPD', 'EXPE',
    'EXPI', 'EXPO', 'EXR', 'EXTR', 'F', 'FAF', 'FANG', 'FAST', 'FATE', 'FBIN',
    'FBK', 'FCEL', 'FCNCA', 'FCX', 'FDS', 'FDX', 'FDXF', 'FE', 'FELE', 'FFIN',
    'FFIV', 'FG', 'FHN', 'FIBK', 'FICO', 'FIGS', 'FIS', 'FISV', 'FITB', 'FIVE',
    'FIVN', 'FIX', 'FIZZ', 'FLGT', 'FLNC', 'FLNG', 'FLO', 'FLR', 'FLS', 'FLWS',
    'FMBH', 'FMC', 'FMX', 'FN', 'FNB', 'FND', 'FNF', 'FNV', 'FOLD', 'FORM',
    'FORR', 'FOUR', 'FOX', 'FOXA', 'FOXF', 'FRME', 'FRO', 'FROG', 'FRPT', 'FRSH',
    'FRT', 'FSK', 'FSLR', 'FSLY', 'FTI', 'FTNT', 'FTV', 'FUBO', 'FUL', 'FUTU',
    'FWONA', 'FWONK', 'FWRD', 'FWRG', 'G', 'GABC', 'GAIN', 'GASS', 'GATX', 'GBCI',
    'GBDC', 'GBTC', 'GBX', 'GCO', 'GD', 'GDDY', 'GDEN', 'GDYN', 'GE', 'GEF',
    'GEHC', 'GEN', 'GENI', 'GEO', 'GERN', 'GEV', 'GEVO', 'GFF', 'GFS', 'GGG',
    'GH', 'GHC', 'GIII', 'GIL', 'GILD', 'GIS', 'GKOS', 'GL', 'GLAD', 'GLBE',
    'GLOB', 'GLW', 'GM', 'GMAB', 'GME', 'GMED', 'GNK', 'GNRC', 'GNTX', 'GNW',
    'GO', 'GOGO', 'GOLD', 'GOLF', 'GOOD', 'GOOG', 'GOOGL', 'GOOS', 'GPC', 'GPI',
    'GPK', 'GPMT', 'GPN', 'GPOR', 'GPRE', 'GPRO', 'GRAB', 'GRBK', 'GRC', 'GRFS',
    'GRMN', 'GRPN', 'GRWG', 'GS', 'GSAT', 'GSBC', 'GSBD', 'GSK', 'GSL', 'GTBIF',
    'GTES', 'GTLB', 'GTLS', 'GTN', 'GTY', 'GVA', 'GWW', 'GXO', 'H', 'HAE',
    'HAFC', 'HAFN', 'HAIN', 'HAL', 'HALO', 'HAS', 'HASI', 'HAYW', 'HBAN', 'HBB',
    'HBCP', 'HBM', 'HBNC', 'HBT', 'HCA', 'HCAT', 'HCC', 'HCI', 'HCKT', 'HCSG',
    'HD', 'HDB', 'HE', 'HEI', 'HELE', 'HGV', 'HIFS', 'HIG', 'HII', 'HIMS',
    'HIW', 'HL', 'HLF', 'HLI', 'HLMN', 'HLNE', 'HLT', 'HLX', 'HMC', 'HMN',
    'HNI', 'HOFT', 'HOG', 'HOLX', 'HOMB', 'HON', 'HOOD', 'HOPE', 'HOV', 'HP',
    'HPE', 'HPK', 'HPQ', 'HQI', 'HQY', 'HRI', 'HRL', 'HRMY', 'HRTG', 'HRTX',
    'HSIC', 'HST', 'HSTM', 'HSY', 'HTBK', 'HTGC', 'HTH', 'HTLD', 'HUBB', 'HUBG',
    'HUBS', 'HUM', 'HUN', 'HURN', 'HUT', 'HVT', 'HWBK', 'HWC', 'HWKN', 'HWM',
    'HXL', 'HY', 'HYLN', 'HZO', 'IAC', 'IART', 'IBCP', 'IBEX', 'IBIT', 'IBKR',
    'IBM', 'IBN', 'IBOC', 'IBP', 'ICE', 'ICFI', 'ICHR', 'ICLR', 'ICUI', 'IDA',
    'IDCC', 'IDT', 'IDXX', 'IESC', 'IEX', 'IFF', 'IHG', 'IHRT', 'IIIV', 'IIPR',
    'ILMN', 'ILPT', 'IMAX', 'IMMR', 'IMVT', 'INBK', 'INCY', 'INDB', 'INFU', 'INFY',
    'ING', 'INGR', 'INMD', 'INO', 'INOD', 'INSG', 'INSM', 'INSP', 'INSW', 'INTA',
    'INTC', 'INTU', 'INVH', 'IONQ', 'IONS', 'IOSP', 'IOT', 'IOVA', 'IP', 'IPAR',
    'IPGP', 'IQ', 'IQV', 'IR', 'IRDM', 'IREN', 'IRM', 'IRMD', 'IRT', 'IRTC',
    'IRWD', 'ISRG', 'IT', 'ITGR', 'ITRI', 'ITT', 'ITUB', 'ITW', 'IVA', 'IVR',
    'IVT', 'IVZ', 'IX', 'J', 'JACK', 'JAZZ', 'JBGS', 'JBHT', 'JBI', 'JBL',
    'JBLU', 'JBSS', 'JCI', 'JD', 'JEF', 'JELD', 'JHG', 'JJSF', 'JKHY', 'JKS',
    'JLL', 'JNJ', 'JOBY', 'JOE', 'JPM', 'KAI', 'KALU', 'KB', 'KBH', 'KBR',
    'KD', 'KDP', 'KE', 'KEX', 'KEY', 'KEYS', 'KFRC', 'KFY', 'KGC', 'KGS',
    'KHC', 'KIM', 'KKR', 'KLAC', 'KLIC', 'KMB', 'KMI', 'KMT', 'KMX', 'KN',
    'KNSA', 'KNSL', 'KNTK', 'KNX', 'KO', 'KOD', 'KOS', 'KR', 'KRC', 'KREF',
    'KRG', 'KRNT', 'KROS', 'KRP', 'KRUS', 'KRYS', 'KSS', 'KTB', 'KTOS', 'KURA',
    'KVUE', 'KVYO', 'KW', 'KWR', 'KYMR', 'L', 'LADR', 'LAKE', 'LAMR', 'LANC',
    'LAND', 'LASR', 'LAUR', 'LAW', 'LAZ', 'LB', 'LBRDA', 'LBRDK', 'LBRT', 'LC',
    'LCID', 'LCII', 'LCNB', 'LCUT', 'LDI', 'LDOS', 'LE', 'LEA', 'LEG', 'LEGH',
    'LEGN', 'LEN', 'LESL', 'LEU', 'LEVI', 'LFMD', 'LFST', 'LFUS', 'LGIH', 'LGND',
    'LH', 'LHX', 'LI', 'LII', 'LIN', 'LIND', 'LITE', 'LIVN', 'LKFN', 'LKQ',
    'LLY', 'LMAT', 'LMND', 'LMNR', 'LMT', 'LNC', 'LNG', 'LNN', 'LNT', 'LNTH',
    'LNZA', 'LOB', 'LOCO', 'LOGI', 'LOOP', 'LOPE', 'LOVE', 'LOW', 'LPG', 'LPL',
    'LPLA', 'LPX', 'LQDT', 'LRCX', 'LSCC', 'LSPD', 'LSTR', 'LTBR', 'LTC', 'LULU',
    'LUMN', 'LUNA', 'LUNG', 'LUNR', 'LUV', 'LVS', 'LW', 'LXRX', 'LXU', 'LYB',
    'LYFT', 'LYV', 'LZB', 'M', 'MA', 'MAA', 'MAIN', 'MANH', 'MAR', 'MARA',
    'MAS', 'MASI', 'MAT', 'MATV', 'MATW', 'MATX', 'MAX', 'MAXN', 'MBC', 'MBIN',
    'MBUU', 'MBWM', 'MC', 'MCB', 'MCBS', 'MCD', 'MCFT', 'MCHP', 'MCK', 'MCO',
    'MCRI', 'MCW', 'MCY', 'MDB', 'MDGL', 'MDLZ', 'MDRX', 'MDT', 'MDU', 'MDXG',
    'MEDP', 'MEG', 'MEI', 'MELI', 'MERC', 'MET', 'META', 'MFA', 'MFC', 'MG',
    'MGA', 'MGEE', 'MGM', 'MGNI', 'MGNX', 'MGPI', 'MGTX', 'MGY', 'MHK', 'MHO',
    'MIDD', 'MIND', 'MIR', 'MIRM', 'MITK', 'MKC', 'MKL', 'MKSI', 'MKTX', 'MLCO',
    'MLEC', 'MLI', 'MLM', 'MLR', 'MMM', 'MMSI', 'MNDY', 'MNKD', 'MNR', 'MNRO',
    'MNSO', 'MNST', 'MNTK', 'MNTS', 'MO', 'MOD', 'MOH', 'MOS', 'MOV', 'MP',
    'MPAA', 'MPB', 'MPC', 'MPLX', 'MPWR', 'MQ', 'MRCY', 'MRK', 'MRM', 'MRNA',
    'MRSH', 'MRTN', 'MRVI', 'MRVL', 'MS', 'MSA', 'MSBI', 'MSCI', 'MSEX', 'MSFT',
    'MSGE', 'MSGS', 'MSI', 'MSM', 'MSTR', 'MT', 'MTB', 'MTCH', 'MTD', 'MTDR',
    'MTG', 'MTH', 'MTLS', 'MTN', 'MTRN', 'MTSI', 'MTW', 'MTX', 'MTZ', 'MU',
    'MUFG', 'MUR', 'MUSA', 'MUX', 'MVBF', 'MVST', 'MWA', 'MXCT', 'MXL', 'MYE',
    'MYFW', 'MYGN', 'MYRG', 'NABL', 'NAT', 'NATH', 'NATR', 'NAVI', 'NBHC', 'NBIS',
    'NBIX', 'NBN', 'NBR', 'NBTB', 'NCLH', 'NCMI', 'NCNO', 'NCSM', 'NDAQ', 'NDLS',
    'NDSN', 'NE', 'NEE', 'NEM', 'NEOG', 'NEON', 'NESR', 'NET', 'NEU', 'NEWT',
    'NEXT', 'NFBK', 'NFE', 'NFG', 'NFLX', 'NG', 'NGS', 'NGVC', 'NGVT', 'NHC',
    'NHI', 'NI', 'NICE', 'NIO', 'NJR', 'NKE', 'NL', 'NLY', 'NMFC', 'NMIH',
    'NMM', 'NMRA', 'NMRK', 'NNE', 'NNI', 'NNN', 'NNOX', 'NOC', 'NODK', 'NOG',
    'NOK', 'NOV', 'NOVT', 'NOW', 'NPK', 'NPO', 'NRC', 'NRDS', 'NREF', 'NRG',
    'NRIM', 'NRIX', 'NSA', 'NSC', 'NSIT', 'NSP', 'NSSC', 'NTAP', 'NTCT', 'NTES',
    'NTGR', 'NTIC', 'NTLA', 'NTNX', 'NTR', 'NTRA', 'NTRS', 'NTST', 'NU', 'NUE',
    'NUS', 'NUVB', 'NVAX', 'NVCR', 'NVDA', 'NVEC', 'NVGS', 'NVO', 'NVR', 'NVS',
    'NVST', 'NVT', 'NWBI', 'NWE', 'NWFL', 'NWL', 'NWN', 'NWPX', 'NWS', 'NWSA',
    'NX', 'NXE', 'NXPI', 'NXRT', 'NXST', 'NXTC', 'NYT', 'O', 'OBDC', 'OBT',
    'OC', 'OCFC', 'OCGN', 'OCSL', 'OCUL', 'ODC', 'ODFL', 'OEC', 'OFG', 'OFIX',
    'OFLX', 'OGE', 'OGI', 'OGN', 'OGS', 'OHI', 'OI', 'OII', 'OIS', 'OKE',
    'OKLO', 'OKTA', 'OLLI', 'OLN', 'OLP', 'OM', 'OMC', 'OMCL', 'OMER', 'OMF',
    'ON', 'ONB', 'ONDS', 'ONEW', 'ONON', 'ONTO', 'OPBK', 'OPEN', 'OPFI', 'OPK',
    'OPRA', 'OPRT', 'OPY', 'ORA', 'ORC', 'ORCL', 'ORGO', 'ORI', 'ORIC', 'ORLA',
    'ORLY', 'ORN', 'ORRF', 'OSCR', 'OSIS', 'OSK', 'OSPN', 'OSUR', 'OSW', 'OTIS',
    'OTLY', 'OTTR', 'OUST', 'OUT', 'OVBC', 'OVV', 'OWL', 'OXM', 'OXY', 'OZK',
    'PAA', 'PAAS', 'PAC', 'PACB', 'PACK', 'PAG', 'PAGP', 'PAGS', 'PAHC', 'PANL',
    'PANW', 'PAR', 'PARR', 'PATH', 'PATK', 'PAY', 'PAYC', 'PAYS', 'PAYX', 'PB',
    'PBA', 'PBF', 'PBFS', 'PBH', 'PBI', 'PBR', 'PCAR', 'PCB', 'PCG', 'PCOR',
    'PCRX', 'PCTY', 'PCVX', 'PD', 'PDD', 'PDM', 'PEG', 'PEGA', 'PENN', 'PEP',
    'PERI', 'PESI', 'PFE', 'PFG', 'PFGC', 'PFSI', 'PG', 'PGNY', 'PGR', 'PH',
    'PHM', 'PII', 'PINS', 'PIPR', 'PJT', 'PKG', 'PKX', 'PL', 'PLAY', 'PLCE',
    'PLD', 'PLMR', 'PLNT', 'PLTR', 'PLUG', 'PLUS', 'PM', 'PNC', 'PNFP', 'PNR',
    'PNW', 'PODD', 'POOL', 'POR', 'POST', 'POWI', 'POWL', 'PPC', 'PPG', 'PPL',
    'PR', 'PRAA', 'PRCT', 'PRDO', 'PRGO', 'PRGS', 'PRI', 'PRIM', 'PRPL', 'PRTA',
    'PRU', 'PSA', 'PSFE', 'PSKY', 'PSN', 'PSTG', 'PSX', 'PTC', 'PTEN', 'PTON',
    'PUBM', 'PUMP', 'PVH', 'PWR', 'PYPL', 'Q', 'QBTS', 'QCOM', 'QLYS', 'QRVO',
    'QS', 'QSI', 'QUBT', 'RACE', 'RAIL', 'RAMP', 'RARE', 'RBC', 'RBLX', 'RCAT',
    'RCKT', 'RCL', 'RCUS', 'RDDT', 'RDN', 'RDW', 'REG', 'REGN', 'RELY', 'REPX',
    'REXR', 'RF', 'RGLD', 'RGNX', 'RGR', 'RGTI', 'RH', 'RHP', 'RIG', 'RILY',
    'RIO', 'RIOT', 'RITM', 'RIVN', 'RJF', 'RKLB', 'RKT', 'RL', 'RLI', 'RMD',
    'RNG', 'RNR', 'ROAD', 'ROCK', 'ROK', 'ROKU', 'ROL', 'ROOT', 'ROP', 'ROST',
    'RPD', 'RPM', 'RPRX', 'RRC', 'RRR', 'RRX', 'RS', 'RSG', 'RSI', 'RTX',
    'RUN', 'RVLV', 'RVMD', 'RVTY', 'RXO', 'RXRX', 'RYAM', 'RYAN', 'S', 'SAIA',
    'SAIC', 'SAM', 'SAN', 'SAP', 'SARO', 'SATS', 'SB', 'SBAC', 'SBCF', 'SBLK',
    'SBRA', 'SBUX', 'SCHD', 'SCHW', 'SCVL', 'SD', 'SE', 'SEDG', 'SEE', 'SEIC',
    'SF', 'SFL', 'SFM', 'SFNC', 'SHAK', 'SHEL', 'SHG', 'SHLS', 'SHOO', 'SHOP',
    'SHW', 'SIG', 'SIRI', 'SITE', 'SJM', 'SKLZ', 'SKM', 'SLB', 'SLDP', 'SLF',
    'SLM', 'SLRC', 'SLVM', 'SM', 'SMCI', 'SMFG', 'SMMT', 'SMPL', 'SMR', 'SMTC',
    'SNA', 'SNAP', 'SNDK', 'SNDL', 'SNDR', 'SNEX', 'SNOW', 'SNPS', 'SNY', 'SO',
    'SOFI', 'SOLV', 'SON', 'SONY', 'SOUN', 'SPB', 'SPCE', 'SPG', 'SPGI', 'SPOT',
    'SPSC', 'SPXC', 'SPY', 'SR', 'SRE', 'SRPT', 'SSB', 'SSNC', 'SSP', 'STAG',
    'STE', 'STEM', 'STEP', 'STLA', 'STLD', 'STNE', 'STNG', 'STRA', 'STRL', 'STT',
    'STWD', 'STX', 'STZ', 'SUI', 'SUZ', 'SW', 'SWK', 'SWKS', 'SWX', 'SXI',
    'SXT', 'SYF', 'SYK', 'SYM', 'SYNA', 'SYY', 'T', 'TAL', 'TALO', 'TAP',
    'TASK', 'TCBI', 'TCOM', 'TD', 'TDG', 'TDW', 'TDY', 'TEAM', 'TECH', 'TEL',
    'TEM', 'TENB', 'TER', 'TEVA', 'TFC', 'TFX', 'TGT', 'TGTX', 'THR', 'TIGR',
    'TITN', 'TJX', 'TK', 'TKO', 'TLN', 'TLRY', 'TM', 'TMDX', 'TME', 'TMO',
    'TMUS', 'TNDM', 'TNET', 'TNK', 'TOL', 'TOST', 'TPC', 'TPG', 'TPL', 'TPR',
    'TPVG', 'TREE', 'TREX', 'TRGP', 'TRI', 'TRIP', 'TRMB', 'TRMD', 'TRN', 'TROW',
    'TROX', 'TRV', 'TSCO', 'TSLA', 'TSLX', 'TSM', 'TSN', 'TT', 'TTC', 'TTD',
    'TTE', 'TTGT', 'TTWO', 'TV', 'TW', 'TWLO', 'TWO', 'TWST', 'TXN', 'TXRH',
    'TXT', 'TYL', 'U', 'UAL', 'UBER', 'UBSI', 'UDR', 'UEC', 'UFPI', 'UHS',
    'UL', 'ULTA', 'UMH', 'UNH', 'UNIT', 'UNP', 'UPBD', 'UPS', 'UPST', 'URBN',
    'URG', 'URI', 'USB', 'USFD', 'USNA', 'UTHR', 'UTL', 'UUUU', 'UWMC', 'V',
    'VALE', 'VEEV', 'VERA', 'VERX', 'VFC', 'VFF', 'VIAV', 'VICI', 'VIRT', 'VIST',
    'VKTX', 'VLO', 'VLTO', 'VMC', 'VNDA', 'VNO', 'VNOM', 'VOYA', 'VPG', 'VRNS',
    'VRSK', 'VRSN', 'VRT', 'VRTX', 'VSCO', 'VST', 'VTOL', 'VTR', 'VTRS', 'VXRT',
    'VZ', 'W', 'WAB', 'WAL', 'WAT', 'WBD', 'WCC', 'WD', 'WDAY', 'WDC',
    'WDFC', 'WEC', 'WELL', 'WEN', 'WERN', 'WEX', 'WFC', 'WFRD', 'WGO', 'WH',
    'WHD', 'WING', 'WIT', 'WK', 'WKHS', 'WLK', 'WLY', 'WM', 'WMB', 'WMG',
    'WMK', 'WMS', 'WMT', 'WOLF', 'WPM', 'WRB', 'WRBY', 'WSBC', 'WSC', 'WSM',
    'WST', 'WTFC', 'WTM', 'WTRG', 'WTS', 'WTW', 'WU', 'WULF', 'WWD', 'WY',
    'WYNN', 'XEL', 'XENE', 'XNCR', 'XOM', 'XP', 'XPEV', 'XPO', 'XPOF', 'XRAY',
    'XYL', 'XYZ', 'YELP', 'YETI', 'YMM', 'YOU', 'YUM', 'Z', 'ZBH', 'ZBRA',
    'ZETA', 'ZG', 'ZIM', 'ZION', 'ZM', 'ZS', 'ZTO', 'ZTS', 'ZUMZ', 'ZWS'
]
...
def get_health_metrics(ticker: yf.Ticker) -> dict:
    """
    Build annual time-series data for the Business Health dashboard.

    Pulls the last 4-5 fiscal years from yfinance and returns:
      - revenue       (millions) — proxy for customer acquisition / business growth
      - net_income    (millions)
      - fcf           (millions) — free cash flow
      - total_debt    (millions)
      - roic          (%) — return on invested capital

    All None entries mean data was unavailable for that year.
    """
    empty = {'years': [], 'revenue': [], 'net_income': [], 'fcf': [], 'total_debt': [], 'roic': [],
             'gross_margin': [], 'shares': [], 'fcf_yield': []}
    try:
        fin = ticker.financials   # annual income statement (rows=items, cols=dates)
        bs  = ticker.balance_sheet
        cf  = ticker.cashflow
        ...
        for date in dates:
            ...
            # --- Total Debt + ROIC (both need balance sheet) ---
            debt_v = None
            roic_v = None
            ...
            for lbl in ['Gross Profit']:
                if lbl in fin.index:
                    v = fin.loc[lbl, date]
                    if pd.notna(v):
                        gross_profit_raw = float(v)
                        break
            if gross_profit_raw is not None and revenue[-1] is not None and revenue[-1] > 0:
                gm_v = round((gross_profit_raw / (revenue[-1] * 1e6)) * 100, 1)
            ...
            # --- FCF Yield % (FCF / market cap at fiscal year-end) ---
            fcf_yield_v = None
            if fcf_v is not None:
                # Get stock price near fiscal year-end to estimate market cap
                try:
                    ...
                    if not hist.empty:
                        ...
                        # Use shares from this year if available
                        if shares_v is not None and shares_v > 0:
                            mkt_cap_m = close_price * shares_v  # shares already in millions
                            if mkt_cap_m > 0:
        ...
        return {
            ...
            'roic':         roic,
            'gross_margin': gross_margin_pcts,
            'shares':       shares_list,
...
def fetch_fundamental_data(symbol: str) -> dict:
    ...
    try:
        ...
        # Business health time-series (dashboard charts)
        health_data = get_health_metrics(ticker)
...
def calculate_stock_signals(symbol: str, spy_monthly: pd.Series = None) -> Optional[dict]:
    ...
    # Bean Score-adjacent dislocation signals (per-stock portion; the
    # cross-sectional fields are filled in a post-pass in main()).
    try:
        dislocation = compute_stock_dislocation(df_complete, fundamentals)
    except Exception:
        dislocation = None
    ...
    result = {
        ...
        # Dislocation scores (Bean Score-adjacent)
        ...
        # Business health dashboard
        'health_chart': fundamentals['health_chart'],
        # Metadata
        # Show the Friday close date for this weekly candle.
        # yfinance labels weekly candles by Monday, but users care about Friday close.
        'last_updated': (df_complete.index[-1] + pd.DateOffset(days=(4 - df_complete.index[-1].weekday()) % 7)).strftime('%Y-%m-%d'),
...
def _slim_stock(stock: dict) -> dict:
    ...
    """
    heavy_fields = {'growth_chart', 'touch_chart', 'health_chart', 'historical_touches', 'insider_buys'}
...
def main():
    ...
    # intensity percentile, signal stack). Needs sector metadata, which was
    # merged above. Mutates stocks in place; never fatal.
    try:
        apply_cross_sectional_dislocation(all_stocks)
        stacked = sum(1 for s in all_stocks
                      if (s.get('dislocation') or {}).get('dislocation_stack', 0) >= 2)
        print(f"\n  Dislocation scores computed; {stacked} stocks with 2+ stacked signals")
    except Exception as e:
        print(f"\n  ⚠ Dislocation post-pass failed (non-fatal): {e}")
