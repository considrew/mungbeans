...
STOCK_UNIVERSE = [
    'A', 'AA', 'AAL', 'AAOI', 'AAON', 'AAP', 'AAPL', 'ABBV', 'ABCB', 'ABG',
    'ABM', 'ABNB', 'ABR', 'ABT', 'ACAD', 'ACB', 'ACCO', 'ACGL', 'ACHR', 'ACIW',
    'ACLS', 'ACLX', 'ACM', 'ACMR', 'ACN', 'ACVA', 'ADBE', 'ADC', 'ADEA', 'ADI',
    'ADM', 'ADMA', 'ADNT', 'ADP', 'ADPT', 'ADSK', 'ADTN', 'ADUS', 'AEE', 'AEIS',
    'AEM', 'AEO', 'AEP', 'AES', 'AFG', 'AFL', 'AFRM', 'AG', 'AGCO', 'AGNC',
    'AGO', 'AHCO', 'AHH', 'AI', 'AIG', 'AIN', 'AIT', 'AIV', 'AIZ', 'AJG',
    'AKAM', 'AKR', 'AKRO', 'ALB', 'ALE', 'ALEC', 'ALEX', 'ALGM', 'ALGN', 'ALGT',
    'ALHC', 'ALIT', 'ALK', 'ALKS', 'ALKT', 'ALL', 'ALLE', 'ALLO', 'ALLY', 'ALNY',
    'ALRM', 'ALRS', 'AM', 'AMAT', 'AMBA', 'AMC', 'AMCR', 'AMD', 'AME', 'AMG',
    'AMGN', 'AMKR', 'AMP', 'AMPH', 'AMPL', 'AMPX', 'AMR', 'AMRC', 'AMRK', 'AMRX',
    'AMT', 'AMWD', 'AMZN', 'ANAB', 'ANDE', 'ANET', 'ANF', 'ANGI', 'ANIK', 'ANIP',
    'AON', 'AORT', 'AOS', 'AOSL', 'APA', 'APAM', 'APD', 'APEI', 'APG', 'APH',
    'APLD', 'APLE', 'APLS', 'APO', 'APOG', 'APP', 'APPF', 'APPN', 'APPS', 'APTV',
    'AQN', 'AR', 'ARAY', 'ARCB', 'ARCC', 'ARCH', 'ARCT', 'ARDX', 'ARE', 'ARES',
    'ARGX', 'ARHS', 'ARIS', 'ARKO', 'ARLP', 'ARM', 'AROC', 'AROW', 'ARQT', 'ARR',
    'ARRY', 'ARTNA', 'ARVN', 'ARW', 'ASAN', 'ASB', 'ASC', 'ASGN', 'ASIX', 'ASLE',
    'ASML', 'ASPI', 'ASPN', 'ASTE', 'ASTS', 'ATEC', 'ATEN', 'ATHM', 'ATI', 'ATKR',
    'ATNI', 'ATO', 'ATRA', 'ATRC', 'ATRO', 'AUB', 'AUR', 'AVA', 'AVAH', 'AVAV',
    'AVB', 'AVGO', 'AVNS', 'AVNT', 'AVNW', 'AVO', 'AVPT', 'AVTR', 'AVY', 'AWI',
    'AWK', 'AWR', 'AX', 'AXGN', 'AXON', 'AXP', 'AXS', 'AXSM', 'AXTA', 'AXTI',
    'AYI', 'AZEK', 'AZN', 'AZO', 'AZTA', 'AZZ', 'B', 'BA', 'BABA', 'BAC',
    'BALL', 'BALY', 'BANC', 'BANF', 'BANR', 'BARK', 'BAX', 'BB', 'BBAI', 'BBW',
    'BBY', 'BC', 'BCC', 'BCE', 'BCML', 'BCO', 'BCPC', 'BCRX', 'BCSF', 'BDC',
    'BDX', 'BE', 'BEAM', 'BECN', 'BEN', 'BEP', 'BF-B', 'BFAM', 'BG', 'BGC',
    'BGFV', 'BGS', 'BHB', 'BHE', 'BHF', 'BHP', 'BHVN', 'BIDU', 'BIIB', 'BILI',
    'BILL', 'BIO', 'BIRK', 'BITF', 'BJ', 'BJRI', 'BK', 'BKD', 'BKE', 'BKH',
    'BKNG', 'BKR', 'BKSY', 'BKU', 'BL', 'BLBD', 'BLCO', 'BLD', 'BLDR', 'BLFS',
    'BLK', 'BLKB', 'BLMN', 'BLNK', 'BMBL', 'BMI', 'BMRC', 'BMRN', 'BMY', 'BNL',
    'BNTX', 'BOH', 'BOKF', 'BOOM', 'BOOT', 'BOX', 'BP', 'BPOP', 'BR', 'BRBR',
    'BRC', 'BRCC', 'BRK-B', 'BRKR', 'BRO', 'BROS', 'BRSP', 'BRX', 'BRY', 'BRZE',
    'BSM', 'BSRR', 'BSX', 'BTAI', 'BTBT', 'BTDR', 'BTG', 'BTI', 'BTU', 'BURL',
    'BUSE', 'BV', 'BWA', 'BWFG', 'BWXT', 'BX', 'BXC', 'BXMT', 'BXP', 'BXSL',
    'BY', 'BYD', 'BYND', 'BYON', 'C', 'CAC', 'CACC', 'CACI', 'CADE', 'CAG',
    'CAH', 'CAKE', 'CAL', 'CALM', 'CALX', 'CAMP', 'CAMT', 'CAR', 'CARG', 'CARR',
    'CASS', 'CAT', 'CATC', 'CATO', 'CATY', 'CAVA', 'CB', 'CBAN', 'CBFV', 'CBL',
    'CBNK', 'CBOE', 'CBRE', 'CBRL', 'CBT', 'CBU', 'CBZ', 'CC', 'CCBG', 'CCI',
    'CCJ', 'CCL', 'CCNE', 'CCOI', 'CCS', 'CCSI', 'CDE', 'CDNA', 'CDNS', 'CDP',
    'CDRE', 'CDW', 'CDXS', 'CE', 'CECO', 'CEG', 'CEIX', 'CELH', 'CENT', 'CENTA',
    'CENX', 'CERS', 'CERT', 'CEVA', 'CF', 'CFFI', 'CFG', 'CFLT', 'CFR', 'CG',
    'CGC', 'CGNX', 'CHCT', 'CHD', 'CHDN', 'CHE', 'CHEF', 'CHGG', 'CHH', 'CHPT',
    'CHRD', 'CHRS', 'CHRW', 'CHTR', 'CHWY', 'CI', 'CIEN', 'CIFR', 'CIGI', 'CIM',
    'CINF', 'CIVB', 'CIVI', 'CL', 'CLB', 'CLBK', 'CLBT', 'CLCO', 'CLDT', 'CLF',
    'CLFD', 'CLH', 'CLNE', 'CLOV', 'CLPR', 'CLSK', 'CLVT', 'CLW', 'CLX', 'CMA',
    'CMC', 'CMCO', 'CMCSA', 'CME', 'CMG', 'CMI', 'CMPR', 'CMRE', 'CMS', 'CMT',
    'CNA', 'CNC', 'CNDT', 'CNK', 'CNMD', 'CNNE', 'CNO', 'CNOB', 'CNP', 'CNTY',
    'CNX', 'CNXC', 'COF', 'COGT', 'COHR', 'COHU', 'COIN', 'COKE', 'COLD', 'COLL',
    'COLM', 'COMM', 'COMP', 'COO', 'COOP', 'COP', 'COR', 'CORT', 'CORZ', 'COST',
    'COTY', 'COUR', 'CPAY', 'CPB', 'CPK', 'CPNG', 'CPRI', 'CPRT', 'CPRX', 'CPT',
    'CQP', 'CR', 'CRBG', 'CRC', 'CRCL', 'CRGY', 'CRH', 'CRI', 'CRK', 'CRL',
    'CRM', 'CRMD', 'CRMT', 'CRNX', 'CRON', 'CROX', 'CRS', 'CRSP', 'CRSR', 'CRTO',
    'CRUS', 'CRVL', 'CRWD', 'CSCO', 'CSGP', 'CSGS', 'CSIQ', 'CSTL', 'CSTM', 'CSV',
    'CSWC', 'CSWI', 'CSX', 'CTAS', 'CTO', 'CTRA', 'CTSH', 'CTVA', 'CUBI', 'CUK',
    'CURLF', 'CUZ', 'CVBF', 'CVCO', 'CVGI', 'CVGW', 'CVLG', 'CVLT', 'CVNA', 'CVS',
    'CVX', 'CW', 'CWAN', 'CWEN', 'CWH', 'CWST', 'CXM', 'CXT', 'CXW', 'CYBR',
    'CYH', 'CYRX', 'CYTK', 'CZR', 'D', 'DAC', 'DAKT', 'DAL', 'DAN', 'DAR',
    'DASH', 'DAWN', 'DBD', 'DBI', 'DBX', 'DCBO', 'DCGO', 'DCI', 'DD', 'DDD',
    'DDOG', 'DDS', 'DE', 'DEA', 'DECK', 'DEI', 'DELL', 'DEO', 'DFIN', 'DG',
    'DGII', 'DGX', 'DHC', 'DHI', 'DHR', 'DHT', 'DIN', 'DINO', 'DIOD', 'DIS',
    'DJT', 'DKNG', 'DKS', 'DLB', 'DLHC', 'DLO', 'DLR', 'DLTR', 'DLX', 'DMLP',
    'DNA', 'DNLI', 'DNN', 'DNOW', 'DNUT', 'DOC', 'DOCN', 'DOCS', 'DOCU', 'DOMO',
    'DORM', 'DOV', 'DOW', 'DOX', 'DPZ', 'DQ', 'DRH', 'DRI', 'DRVN', 'DSGX',
    'DSX', 'DT', 'DTE', 'DTM', 'DUK', 'DUOL', 'DV', 'DVA', 'DVAX', 'DVN',
    'DX', 'DXC', 'DXCM', 'DY', 'EA', 'EAT', 'EBAY', 'EBC', 'ECL', 'ECPG',
    'ECVT', 'ED', 'EDIT', 'EDU', 'EE', 'EEFT', 'EFSC', 'EFX', 'EG', 'EGBN',
    'EGO', 'EGP', 'EHC', 'EIX', 'EL', 'ELF', 'ELME', 'ELS', 'ELV', 'EMBC',
    'EME', 'EMN', 'EMR', 'ENB', 'ENOV', 'ENPH', 'ENS', 'ENSG', 'ENTA', 'ENTG',
    'ENVA', 'ENVX', 'EOG', 'EPAC', 'EPAM', 'EPC', 'EPD', 'EPM', 'EPRT', 'EQBK',
    'EQH', 'EQIX', 'EQNR', 'EQR', 'EQT', 'ERIE', 'ERII', 'ES', 'ESCA', 'ESE',
    'ESEA', 'ESGR', 'ESI', 'ESNT', 'ESPR', 'ESRT', 'ESS', 'ESTA', 'ESTC', 'ET',
    'ETD', 'ETHE', 'ETN', 'ETR', 'ETSY', 'EU', 'EVC', 'EVCM', 'EVER', 'EVGO',
    'EVH', 'EVLV', 'EVR', 'EVRG', 'EVTC', 'EW', 'EWBC', 'EXAS', 'EXC', 'EXE',
    'EXEL', 'EXLS', 'EXP', 'EXPD', 'EXPE', 'EXPI', 'EXPO', 'EXR', 'EXTR', 'F',
    'FAF', 'FANG', 'FAST', 'FATE', 'FBIN', 'FBK', 'FCEL', 'FCNCA', 'FCX', 'FDS',
    'FDX', 'FE', 'FELE', 'FFIN', 'FFIV', 'FG', 'FHN', 'FIBK', 'FICO', 'FIGS',
    'FIS', 'FISV', 'FITB', 'FIVE', 'FIVN', 'FIX', 'FIZZ', 'FLGT', 'FLNC', 'FLNG',
    'FLO', 'FLR', 'FLS', 'FLWS', 'FMBH', 'FMC', 'FMX', 'FN', 'FNB', 'FND',
    'FNF', 'FNV', 'FOLD', 'FORM', 'FORR', 'FOUR', 'FOX', 'FOXA', 'FOXF', 'FRME',
    'FRO', 'FROG', 'FRPT', 'FRSH', 'FRT', 'FSK', 'FSLR', 'FSLY', 'FTI', 'FTNT',
    'FTV', 'FUBO', 'FUL', 'FUTU', 'FWONA', 'FWONK', 'FWRD', 'FWRG', 'G', 'GABC',
    'GAIN', 'GASS', 'GATX', 'GBCI', 'GBDC', 'GBTC', 'GBX', 'GCO', 'GD', 'GDDY',
    'GDEN', 'GDYN', 'GE', 'GEF', 'GEHC', 'GEN', 'GENI', 'GEO', 'GERN', 'GES',
    'GEV', 'GEVO', 'GFF', 'GFS', 'GGG', 'GH', 'GHC', 'GIII', 'GIL', 'GILD',
    'GIS', 'GKOS', 'GL', 'GLAD', 'GLBE', 'GLDD', 'GLOB', 'GLW', 'GM', 'GMAB',
    'GME', 'GMED', 'GMRE', 'GNK', 'GNRC', 'GNTX', 'GNW', 'GO', 'GOEV', 'GOGL',
    'GOGO', 'GOLD', 'GOLF', 'GOOD', 'GOOG', 'GOOGL', 'GOOS', 'GPC', 'GPI', 'GPK',
    'GPMT', 'GPN', 'GPOR', 'GPRE', 'GPRO', 'GRAB', 'GRBK', 'GRC', 'GRFS', 'GRMN',
    'GRPN', 'GRWG', 'GS', 'GSAT', 'GSBC', 'GSBD', 'GSK', 'GSL', 'GTBIF', 'GTES',
    'GTLB', 'GTLS', 'GTN', 'GTY', 'GVA', 'GWW', 'GXO', 'H', 'HAE', 'HAFC',
    'HAFN', 'HAIN', 'HAL', 'HALO', 'HAS', 'HASI', 'HAYW', 'HBAN', 'HBB', 'HBCP',
    'HBM', 'HBNC', 'HBT', 'HCA', 'HCAT', 'HCC', 'HCI', 'HCKT', 'HCSG', 'HD',
    'HDB', 'HE', 'HEI', 'HELE', 'HGV', 'HI', 'HIFS', 'HIG', 'HII', 'HIMS',
    'HIW', 'HL', 'HLF', 'HLI', 'HLMN', 'HLNE', 'HLT', 'HLX', 'HMN', 'HNI',
    'HOFT', 'HOG', 'HOLX', 'HOMB', 'HON', 'HOOD', 'HOPE', 'HOV', 'HP', 'HPE',
    'HPK', 'HPQ', 'HQI', 'HQY', 'HRI', 'HRL', 'HRMY', 'HRTG', 'HRTX', 'HSIC',
    'HST', 'HSTM', 'HSY', 'HTBK', 'HTGC', 'HTH', 'HTLD', 'HUBB', 'HUBG', 'HUBS',
    'HUM', 'HUN', 'HURN', 'HUT', 'HVT', 'HWBK', 'HWC', 'HWKN', 'HWM', 'HXL',
    'HY', 'HYLN', 'HZO', 'IAC', 'IART', 'IBCP', 'IBEX', 'IBIT', 'IBKR', 'IBM',
    'IBN', 'IBOC', 'IBP', 'ICE', 'ICFI', 'ICHR', 'ICLR', 'ICUI', 'IDA', 'IDCC',
    'IDT', 'IDXX', 'IESC', 'IEX', 'IFF', 'IHG', 'IHRT', 'IIIV', 'IIPR', 'ILMN',
    'ILPT', 'IMAX', 'IMMR', 'IMVT', 'INBK', 'INCY', 'INDB', 'INFU', 'INFY', 'ING',
    'INGR', 'INMD', 'INO', 'INOD', 'INSG', 'INSM', 'INSP', 'INSW', 'INTA', 'INTC',
    'INTU', 'INVH', 'IONQ', 'IONS', 'IOSP', 'IOT', 'IOVA', 'IP', 'IPAR', 'IPGP',
    'IQ', 'IQV', 'IR', 'IRBT', 'IRDM', 'IREN', 'IRM', 'IRMD', 'IRT', 'IRTC',
    'IRWD', 'ISRG', 'IT', 'ITGR', 'ITRI', 'ITT', 'ITUB', 'ITW', 'IVA', 'IVR',
    'IVT', 'IVZ', 'IX', 'J', 'JACK', 'JAMF', 'JAZZ', 'JBGS', 'JBHT', 'JBI',
    'JBL', 'JBLU', 'JBSS', 'JCI', 'JD', 'JEF', 'JELD', 'JHG', 'JJSF', 'JKHY',
    'JKS', 'JLL', 'JNJ', 'JOBY', 'JOE', 'JPM', 'KAI', 'KALU', 'KAR', 'KB',
    'KBH', 'KBR', 'KD', 'KDP', 'KE', 'KEX', 'KEY', 'KEYS', 'KFRC', 'KFY',
    'KGC', 'KGS', 'KHC', 'KIM', 'KKR', 'KLAC', 'KLIC', 'KMB', 'KMI', 'KMT',
    'KMX', 'KN', 'KNSA', 'KNSL', 'KNTK', 'KNX', 'KO', 'KOD', 'KOS', 'KR',
    'KRC', 'KREF', 'KRG', 'KRNT', 'KROS', 'KRP', 'KRUS', 'KRYS', 'KSS', 'KTB',
    'KTOS', 'KURA', 'KVUE', 'KVYO', 'KW', 'KWR', 'KYMR', 'L', 'LADR', 'LAKE',
    'LAMR', 'LANC', 'LAND', 'LASR', 'LAUR', 'LAW', 'LAZ', 'LAZR', 'LB', 'LBRDA',
    'LBRDK', 'LBRT', 'LC', 'LCID', 'LCII', 'LCNB', 'LCUT', 'LDI', 'LDOS', 'LE',
    'LEA', 'LEG', 'LEGH', 'LEGN', 'LEN', 'LESL', 'LEU', 'LEVI', 'LFMD', 'LFST',
    'LFUS', 'LGIH', 'LGND', 'LH', 'LHX', 'LI', 'LII', 'LIN', 'LIND', 'LITE',
    'LIVN', 'LKFN', 'LKQ', 'LLY', 'LMAT', 'LMND', 'LMNR', 'LMT', 'LNC', 'LNG',
    'LNN', 'LNT', 'LNTH', 'LNZA', 'LOB', 'LOCO', 'LOGI', 'LOOP', 'LOPE', 'LOVE',
    'LOW', 'LPG', 'LPLA', 'LPX', 'LQDT', 'LRCX', 'LSCC', 'LSPD', 'LSTR', 'LTBR',
    'LTC', 'LULU', 'LUMN', 'LUNA', 'LUNG', 'LUNR', 'LUV', 'LVS', 'LW', 'LXRX',
    'LXU', 'LYB', 'LYFT', 'LYV', 'LZB', 'M', 'MA', 'MAA', 'MAIN', 'MANH',
    'MAR', 'MARA', 'MAS', 'MASI', 'MAT', 'MATV', 'MATW', 'MATX', 'MAX', 'MAXN',
    'MBC', 'MBCN', 'MBIN', 'MBUU', 'MBWM', 'MC', 'MCB', 'MCBS', 'MCD', 'MCFT',
    'MCHP', 'MCK', 'MCO', 'MCRI', 'MCW', 'MCY', 'MDB', 'MDGL', 'MDLZ', 'MDRX',
    'MDT', 'MDU', 'MDXG', 'MEDP', 'MEG', 'MEI', 'MELI', 'MERC', 'MET', 'META',
    'MFA', 'MG', 'MGEE', 'MGM', 'MGNI', 'MGNX', 'MGPI', 'MGTX', 'MGY', 'MHK',
    'MHO', 'MIDD', 'MIND', 'MIR', 'MIRM', 'MITK', 'MKC', 'MKL', 'MKSI', 'MKTX',
    'MLCO', 'MLEC', 'MLI', 'MLM', 'MLR', 'MMM', 'MMSI', 'MNDY', 'MNKD', 'MNR',
    'MNRO', 'MNSO', 'MNST', 'MNTK', 'MNTS', 'MO', 'MOD', 'MODG', 'MOFG', 'MOH',
    'MOS', 'MOV', 'MP', 'MPAA', 'MPB', 'MPC', 'MPLX', 'MPW', 'MPWR', 'MQ',
    'MRCY', 'MRK', 'MRM', 'MRNA', 'MRSH', 'MRSN', 'MRTN', 'MRUS', 'MRVI', 'MRVL',
    'MS', 'MSA', 'MSBI', 'MSCI', 'MSEX', 'MSFT', 'MSGE', 'MSGS', 'MSI', 'MSM',
    'MSTR', 'MT', 'MTB', 'MTCH', 'MTD', 'MTDR', 'MTG', 'MTH', 'MTLS', 'MTN',
    'MTRN', 'MTSI', 'MTW', 'MTX', 'MTZ', 'MU', 'MUFG', 'MUR', 'MUSA', 'MUX',
    'MVBF', 'MVST', 'MWA', 'MXCT', 'MXL', 'MYE', 'MYFW', 'MYGN', 'MYRG', 'NABL',
    'NAT', 'NATH', 'NATR', 'NAVI', 'NBHC', 'NBIS', 'NBIX', 'NBN', 'NBR', 'NBTB',
    'NCLH', 'NCMI', 'NCNO', 'NCSM', 'NDAQ', 'NDLS', 'NDSN', 'NE', 'NEE', 'NEM',
    'NEOG', 'NEON', 'NESR', 'NET', 'NEU', 'NEWT', 'NEXT', 'NFBK', 'NFE', 'NFG',
    'NFLX', 'NG', 'NGD', 'NGS', 'NGVC', 'NGVT', 'NHC', 'NHI', 'NI', 'NICE',
    'NIO', 'NJR', 'NKE', 'NL', 'NLY', 'NMFC', 'NMIH', 'NMM', 'NMRA', 'NMRK',
    'NNE', 'NNI', 'NNN', 'NNOX', 'NOC', 'NODK', 'NOG', 'NOK', 'NOV', 'NOVA',
    'NOVT', 'NOW', 'NPK', 'NPO', 'NRC', 'NRDS', 'NREF', 'NRG', 'NRIM', 'NRIX',
    'NSA', 'NSC', 'NSIT', 'NSP', 'NSSC', 'NTAP', 'NTCT', 'NTES', 'NTGR', 'NTIC',
    'NTLA', 'NTNX', 'NTRA', 'NTRS', 'NTST', 'NU', 'NUE', 'NUS', 'NUVB', 'NVAX',
    'NVCR', 'NVDA', 'NVEC', 'NVGS', 'NVO', 'NVR', 'NVS', 'NVST', 'NVT', 'NWBI',
    'NWE', 'NWFL', 'NWL', 'NWN', 'NWPX', 'NWS', 'NWSA', 'NX', 'NXE', 'NXPI',
    'NXRT', 'NXST', 'NXTC', 'NYT', 'O', 'OBDC', 'OBT', 'OC', 'OCFC', 'OCGN',
    'OCSL', 'OCUL', 'ODC', 'ODFL', 'OEC', 'OFG', 'OFIX', 'OFLX', 'OGE', 'OGI',
    'OGN', 'OGS', 'OHI', 'OI', 'OII', 'OIS', 'OKE', 'OKLO', 'OKTA', 'OLLI',
    'OLN', 'OLP', 'OM', 'OMC', 'OMCL', 'OMER', 'OMF', 'OMI', 'ON', 'ONB',
    'ONDS', 'ONEW', 'ONON', 'ONTO', 'OPBK', 'OPEN', 'OPFI', 'OPK', 'OPRA', 'OPRT',
    'OPY', 'ORA', 'ORC', 'ORCL', 'ORGO', 'ORI', 'ORIC', 'ORLA', 'ORLY', 'ORN',
    'ORRF', 'OSCR', 'OSIS', 'OSK', 'OSPN', 'OSUR', 'OSW', 'OTIS', 'OTLY', 'OTTR',
    'OUST', 'OUT', 'OVBC', 'OVV', 'OWL', 'OXM', 'OXY', 'OZK', 'PAA', 'PAAS',
    'PAC', 'PACB', 'PACK', 'PAG', 'PAGP', 'PAGS', 'PAHC', 'PANL', 'PANW', 'PAR',
    'PARR', 'PATH', 'PATI', 'PATK', 'PAY', 'PAYC', 'PAYS', 'PAYX', 'PB', 'PBA',
    'PBF', 'PBFS', 'PBH', 'PBI', 'PBR', 'PCAR', 'PCB', 'PCG', 'PCH', 'PCOR',
    'PCRX', 'PCTY', 'PCVX', 'PD', 'PDD', 'PDM', 'PEG', 'PEGA', 'PENN', 'PEP',
    'PERI', 'PESI', 'PFE', 'PFG', 'PFGC', 'PFSI', 'PG', 'PGNY', 'PGR', 'PH',
    'PHM', 'PII', 'PINS', 'PIPR', 'PJT', 'PKG', 'PL', 'PLAY', 'PLCE', 'PLD',
    'PLMR', 'PLNT', 'PLTR', 'PLUG', 'PLUS', 'PLYM', 'PM', 'PNC', 'PNFP', 'PNR',
    ...
    'RCKT', 'RCL', 'RCUS', 'RDDT', 'RDFN', 'RDN', 'RDW', 'REG', 'REGN', 'RELY',
    'REPX', 'REVG', 'REXR', 'RF', 'RGLD', 'RGNX', 'RGR', 'RGTI', 'RH', 'RHP',
    'RIG', 'RILY', 'RIO', 'RIOT', 'RITM', 'RIVN', 'RJF', 'RKLB', 'RKT', 'RL',
    'RLI', 'RMD', 'RNG', 'RNR', 'ROAD', 'ROCK', 'ROK', 'ROKU', 'ROL', 'ROOT',
    'ROP', 'ROST', 'RPD', 'RPM', 'RPRX', 'RRC', 'RRR', 'RRX', 'RS', 'RSG',
    'RSI', 'RTX', 'RUN', 'RVLV', 'RVMD', 'RVTY', 'RXO', 'RXRX', 'RYAM', 'RYAN',
    'S', 'SAIA', 'SAIC', 'SAM', 'SAN', 'SAP', 'SARO', 'SATS', 'SAVA', 'SB',
    'SBAC', 'SBCF', 'SBLK', 'SBRA', 'SBUX', 'SCHD', 'SCHW', 'SCVL', 'SD', 'SE',
    'SEAS', 'SEDG', 'SEE', 'SEIC', 'SF', 'SFL', 'SFM', 'SFNC', 'SHAK', 'SHEL',
    'SHG', 'SHLS', 'SHOO', 'SHOP', 'SHW', 'SIG', 'SIRI', 'SITE', 'SJM', 'SKLZ',
    'SKM', 'SKX', 'SLB', 'SLDP', 'SLM', 'SLRC', 'SLVM', 'SM', 'SMCI', 'SMFG',
    'SMMT', 'SMPL', 'SMR', 'SMTC', 'SNA', 'SNAP', 'SNDK', 'SNDL', 'SNDR', 'SNEX',
    'SNOW', 'SNPS', 'SNV', 'SNY', 'SO', 'SOFI', 'SOLV', 'SON', 'SONY', 'SOUN',
    'SPB', 'SPCE', 'SPG', 'SPGI', 'SPOT', 'SPSC', 'SPXC', 'SR', 'SRE', 'SRPT',
    'SSB', 'SSNC', 'SSP', 'STAG', 'STE', 'STEM', 'STEP', 'STLA', 'STLD', 'STNG',
    'STRA', 'STRL', 'STT', 'STWD', 'STX', 'STZ', 'SUI', 'SW', 'SWK', 'SWKS',
    'SWTX', 'SWX', 'SXI', 'SXT', 'SYF', 'SYK', 'SYM', 'SYNA', 'SYY', 'T',
    'TAL', 'TALO', 'TAP', 'TASK', 'TCBI', 'TCOM', 'TDG', 'TDW', 'TDY', 'TEAM',
    'TECH', 'TEL', 'TEM', 'TENB', 'TER', 'TEVA', 'TFC', 'TFX', 'TGI', 'TGNA',
    'TGT', 'TGTX', 'THR', 'THS', 'TIGR', 'TITN', 'TJX', 'TK', 'TKO', 'TLN',
    'TLRY', 'TM', 'TMDX', 'TME', 'TMO', 'TMUS', 'TNDM', 'TNET', 'TNK', 'TNP',
    'TOL', 'TOST', 'TPC', 'TPG', 'TPL', 'TPR', 'TPVG', 'TREE', 'TREX', 'TRGP',
    'TRIP', 'TRMB', 'TRMD', 'TRN', 'TROW', 'TROX', 'TRV', 'TSCO', 'TSLA', 'TSLX',
    'TSM', 'TSN', 'TT', 'TTC', 'TTD', 'TTE', 'TTGT', 'TTWO', 'TW', 'TWLO',
    'TWO', 'TWST', 'TXN', 'TXRH', 'TXT', 'TYL', 'U', 'UAL', 'UBER', 'UBSI',
    'UDR', 'UEC', 'UFPI', 'UHS', 'UL', 'ULTA', 'UMH', 'UNH', 'UNIT', 'UNP',
    'UPBD', 'UPS', 'UPST', 'URBN', 'URG', 'URI', 'USB', 'USFD', 'USNA', 'UTHR',
    'UTL', 'UUUU', 'UWMC', 'V', 'VALE', 'VEEV', 'VERA', 'VERX', 'VFC', 'VFF',
    'VIAV', 'VICI', 'VIRT', 'VIST', 'VKTX', 'VLO', 'VLTO', 'VMC', 'VNDA', 'VNO',
    'VNOM', 'VOYA', 'VPG', 'VRNS', 'VRSK', 'VRSN', 'VRT', 'VRTX', 'VSCO', 'VST',
    'VTLE', 'VTOL', 'VTR', 'VTRS', 'VXRT', 'VZ', 'W', 'WAB', 'WAL', 'WAT',
    'WBD', 'WCC', 'WD', 'WDAY', 'WDC', 'WDFC', 'WEC', 'WELL', 'WEN', 'WERN',
    'WEX', 'WFC', 'WFRD', 'WGO', 'WH', 'WHD', 'WING', 'WIT', 'WK', 'WKHS',
    'WLK', 'WLY', 'WM', 'WMB', 'WMG', 'WMK', 'WMS', 'WMT', 'WOLF', 'WPM',
    'WRB', 'WRBY', 'WSBC', 'WSC', 'WSM', 'WST', 'WTFC', 'WTM', 'WTRG', 'WTS',
    'WTW', 'WU', 'WULF', 'WWD', 'WY', 'WYNN', 'XEL', 'XENE', 'XNCR', 'XOM',
    'XPEV', 'XPO', 'XPOF', 'XRAY', 'XYL', 'XYZ', 'YELP', 'YETI', 'YMM', 'YOU',
    'YUM', 'Z', 'ZBH', 'ZBRA', 'ZETA', 'ZG', 'ZIM', 'ZION', 'ZM', 'ZS',
    'ZTO', 'ZTS', 'ZUMZ', 'ZWS',
]
